...
# (e.g. SGLANG_ENABLE_VESTIGEKV_INGRAPH_SCAN=0, SGLANG_DEBUG_VESTIGEKV_STATS=1, GRAPH=0;
#  the per-step row-invariant check is a dev-branch key, not on the submodule branch),
