...
def main():
    ...
    body = [
        ...
        "% Each row is the 4096 tokens ENDING at the context it names, labelled",
        f"% in units of 1024 tokens. The rightmost row is the end of the stream",
        f"% ({top} tokens; the last logged step lands at {last}).",
        "",
