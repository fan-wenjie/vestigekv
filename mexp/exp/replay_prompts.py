...
string appears. Used with SGLANG_DEBUG_VESTIGEKV_STATS=1 to read the per-build VESTIGEKV_CAL (VKCAL in older logs)
...
for task in args.tasks.split(","):
  ...
  for d in docs[args.index : args.index + args.n]:
    ...
    req = {"model": "moonshotai/Kimi-Linear-48B-A3B-Instruct", "prompt": prompt, "max_tokens": args.max_tokens, "temperature": 0,
