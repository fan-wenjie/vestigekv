#!/usr/bin/env bash
# Shared launch prelude for DeepSeek-V2-Lite-Chat (bf16, RoPE MLA) on 2x RTX PRO 6000, engine branch
# vestigekv (the dsv2lite line). Quality/RULER line: CUDA graph ON (decode bs <= GRAPH_BS),
